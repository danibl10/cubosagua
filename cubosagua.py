...
class juegoCubos:
    ...
    def selecOpcion(self):
        ...
        print('  (O)Vaciar todos los cubos')
        print('  (S)alir')
    ...
    def vaciarTodosCubos(self, cuboOrigen):
        for i in ('8', '5', '3'):
    ...
    def llenarTodosCubos(self, cuboOrigen):
        for i in ('8', '5', '3'):
            cuboOrigenTam = int(i)
    ...
    def jugar(self):
        ...
        while True:
            ...
            if opcion == 'T':
                self.llenarTodosCubos(cuboOrigen=('8', '5', '3'))
            elif opcion == 'L':
                cubo = self.selecCubo('Selecciona el cubo 8, 5, 3 o SALIR:')
                self.llenarCubo(cubo)
            elif opcion == 'O':
                self.vaciarTodosCubos(cuboOrigen=('8', '5', '3'))
            elif opcion == "V":
                cubo = self.selecCubo('Selecciona el cubo 8, 5, 3 o SALIR:')
